...
"""
================================================================================
    [03] Price Cross SMA 15 RR2.5
    NAS100 M5 — Michele Piazzoli — Quant Strategy
================================================================================

Standalone backtest script for the #3 ranked strategy.

Strategy:
    - Trigger:      Price Cross SMA 15 (close crosses above/below SMA 15)
    - HTF Filter:   H1 SMA 20
    - Session:      US Main (14:30 - 21:00)
    - SL:           ATR(14) x 1.0
    - RR:           1:2.5
    - Monthly Cap:  10%
...
OUTPUT_BASE     = Path("/Users/capitalpro/Desktop/Strategia 1/[03] Price Cross SMA 15 RR2.5")
...
# Strategy parameters
TRIGGER_PERIOD  = 15       # SMA period for price cross
HTF_SMA_PERIOD  = 20       # H1 SMA period for bias
SESS_START      = "14:30"  # US Main
SESS_END        = "21:00"
SESS_NAME       = "US_Main"
RR              = 2.5
SL_ATR_MULT     = 1.0

STRATEGY_NAME   = "PriceSMA_15"
ASSET           = "NAS100"
TIMEFRAME       = "M5"
